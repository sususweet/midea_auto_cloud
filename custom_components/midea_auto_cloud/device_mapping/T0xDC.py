...
# Original program options — do not remove/rename keys (automations / UI compatibility).
...
# Full program set from midea_dryer.lua (controlMapping / reportMapping).
_LUA_DRYER_PROGRAMS = {
    "cotton": {"program": "cotton"},
    "fiber": {"program": "fiber"},
    "mixed_wash": {"program": "mixed_wash"},
...
DEVICE_MAPPING = {
    "default": {
        ...
        "entities": {
            ...
            Platform.SELECT: {
                "program": {
                    "options": _LEGACY_DRYER_PROGRAMS,
                },
                "intensity": {
                    "options": {
                        "off": {"intensity": "1"},
    ...
    # sn8-specific: full midea_dryer.lua surface (programs + commandSpec attrs).
    "38211209": {
        "rationale": ["off", "on"],
        "queries": [{}],
        "centralized": [],
        "entities": {
            ...
            Platform.SELECT: {
                "program": {
                    # Superset of legacy keys + lua programs (e.g. eco_dry).
                    "options": {**_LEGACY_DRYER_PROGRAMS, **_LUA_DRYER_PROGRAMS},
                },
                "intensity": {
                    "options": _level_options("intensity", range(0, 6)),
                },
                "dryness_level": {
                    "options": _level_options("dryness_level", range(0, 5)),
                },
                "prevent_wrinkle": {
                    "options": _level_options("prevent_wrinkle", range(0, 9)),
                },
                "steam": {
                    "options": _level_options("steam", range(0, 5)),
                },
                "material": {
                    "options": _level_options("material", range(0, 6)),
                },
                "temperature_level": {
                    "options": _level_options("temperature_level", range(0, 6)),
                },
                "smell": {
                    "options": _level_options("smell", range(0, 6)),
                },
            },
            Platform.NUMBER: {
                "dry_time": {
